<template>
  <div>
              ...
              <div slot="title" @click="openReply(item, index)">
                ...
                <div class="info">
                  ...
                  <van-button
                    ...
                    round
                    size="mini"
                    @click.stop="PopupShow(1, item.info.nickname, item._id)"
    ...
    <van-popup v-model="replyPopupShow" :overlay="false" position="bottom" style="height: 100%">
      <replyCom @close="replyPopupShow = false" :replyInfo="replyInfo"></replyCom>
    </van-popup>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    PopupShow(comment_type = 0, reply_placeholder, reply_comment_id) {
      //弹出弹窗
